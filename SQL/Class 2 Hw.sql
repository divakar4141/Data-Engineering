...
cust_last_name ||' '||cust_first_name full_name from sh.customers
...
length(cust_first_name||' '||cust_last_name) full_name_length from sh.customers
...
cust_city||' '||cust_state_province full_adress from sh.customers
