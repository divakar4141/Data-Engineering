...
--  6  select country_id,sum(cust_credit_limit) total_credit_limit from sh.customers group by country_id order by total_credit_limit desc fetch first 1 row only
-- 7
